...
class WINRBranding {
  ...
  factory WINRBranding.defaultBranding({Widget? logo, Widget? logoTwo}) {
    return WINRBranding(
      ...
      secondaryTextColor: Colors.white.withOpacity(0.96),
      mutedTextColor: Colors.white.withOpacity(0.74),
      backgroundColor: const Color(0xFF020617),
      cardBackgroundColor: const Color(0xFF020818),
      cardBorderColor: Colors.white.withOpacity(0.16),
      primaryButtonColor: const Color(0xFF0284FF),
      primaryButtonTextColor: Colors.white,
      secondaryButtonColor: Colors.white.withOpacity(0.06),
      secondaryButtonTextColor: Colors.white.withOpacity(0.92),
      inputFieldBackgroundColor: Colors.white.withOpacity(0.03),
      inputFieldBorderColor: Colors.white.withOpacity(0.18),
      inputFieldPlaceholderColor: Colors.white.withOpacity(0.55),
  ...
  factory WINRBranding.carnivalBlueOrange({Widget? logo, Widget? logoTwo}) {
    return WINRBranding(
      primaryColor: Colors.white,
      secondaryTextColor: Colors.white.withOpacity(0.95),
      mutedTextColor: Colors.white.withOpacity(0.7),
      backgroundColor: const Color(0xFF0F0F1A),
      cardBackgroundColor: const Color(0xFF1E40AF),
      cardBorderColor: const Color(0xFF3B82F6).withOpacity(0.5),
      ...
      inputFieldBackgroundColor: Colors.white.withOpacity(0.08),
      inputFieldBorderColor: Colors.white.withOpacity(0.25),
      inputFieldPlaceholderColor: Colors.white.withOpacity(0.6),
  ...
  factory WINRBranding.luxuryGold({Widget? logo, Widget? logoTwo}) {
    return WINRBranding(
      ...
      mutedTextColor: const Color(0xFFF59E0B).withOpacity(0.8),
      backgroundColor: const Color(0xFF0A0A0A),
      cardBackgroundColor: const Color(0xFF1A1400),
      cardBorderColor: const Color(0xFFF59E0B).withOpacity(0.3),
      ...
      inputFieldBackgroundColor: Colors.black.withOpacity(0.4),
      inputFieldBorderColor: const Color(0xFFF59E0B).withOpacity(0.5),
      inputFieldPlaceholderColor: const Color(0xFFF59E0B).withOpacity(0.7),
  ...
  factory WINRBranding.cosmicPurplePink({Widget? logo, Widget? logoTwo}) {
    return WINRBranding(
      ...
      cardBackgroundColor: Colors.black.withOpacity(0.9),
      cardBorderColor: const Color(0xFFE879F9).withOpacity(0.4),
      primaryButtonColor: const Color(0xFFEC4899),
      primaryButtonTextColor: Colors.white,
      secondaryButtonColor: const Color(0xFFA78BFA),
      secondaryButtonTextColor: Colors.white,
      inputFieldBackgroundColor: Colors.white.withOpacity(0.05),
      inputFieldBorderColor: Colors.white.withOpacity(0.2),
      inputFieldPlaceholderColor: Colors.white.withOpacity(0.6),
