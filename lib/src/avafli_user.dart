/// Represents a user within the Avafli system.
///
...
/// Example:
/// ```dart
/// final user = AvafliUser(id: 'user123');
/// ```
class AvafliUser {
  ...
  /// and submits inside the Avafli flow. A malformed value is ignored and the
  /// field stays editable.
  ///
  /// This is a plain email STRING. For an app with no signed-in user, don't
  /// pass anything here — use [AvafliUser.guest] as the entire `user:` value
  /// instead (`user: AvafliUser.guest`).
  final String? email;
  ...
  /// identifier without your integration fabricating one. The Avafli experience
  ...
  static const AvafliUser guest =
      AvafliUser(id: '', firstName: '', lastName: '');

  /// True when this value is the [guest] sentinel.
  bool get isGuest => id.isEmpty;

  /// Creates a new [AvafliUser].
  ///
  ...
  @override
  String toString() => 'AvafliUser(id: $id)';

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is AvafliUser && runtimeType == other.runtimeType && id == other.id;
